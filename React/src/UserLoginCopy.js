    ...
    fetch("http://localhost:8001/Climate_Bind_Development/login_capture.php", {
      ...
      .then((data) => {
        if (data.status === "success") {
          if (data.registration_status === "Registration data is complete" && data.claims_status === 'No claim submitted') {
            navigate("/DataSubmittedThenClaim");
          } else if (data.registration_status === "Registration data is complete" && data.claims_status === 'Claim active') {
